        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/services/probate-sales" className="text-gray-300 hover:text-white">Probate Sales</Link></li>
              <li><Link href="/services/divorce-property-sales" className="text-gray-300 hover:text-white">Divorce Property Sales</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/locations/folsom-ca" className="text-gray-300 hover:text-white">Folsom, CA</Link></li>
              <li><Link href="/locations/roseville-ca" className="text-gray-300 hover:text-white">Roseville, CA</Link></li>
            </ul>
          </div>
